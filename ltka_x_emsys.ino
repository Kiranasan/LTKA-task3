//Membuat mesin otomatis yang akan mengeluarkan berbagai macam snack sesuai dengan warna gelas
//pantulan cahaya rgb yang mengenai gelas akan ditangkap oleh sensor ldr, warna yang dideteksi akan dicocokkan dengan colour mapping pada data program arduino
//tutup wadah snack akan terbuka ketika servo bergerak sesuai cahaya yang ditangkap oleh photoresistor/ldr
